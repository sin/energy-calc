        ...
        {isDetails ? (
          <div className="Details">
            ...
            <p>
              ...
              budowy, eksploatacji, gospodarki paliwowej i rozbiórki zakładu. Jednostką jest
              kilotona (kt), jedna kilotona to 1000 ton.
            </p>
            <ComparisonTable
              current={today.co2}
            ...
            <p>
              Łączna moc zainstalowana źródła energii to suma mocy znamionowych urządzeń
              generujących energię. Jednostką jest gigawat (GW), jeden gigawat to 1000 megawatów.
            </p>
            <ComparisonTable
            ...
            <p>
              Zdolność produkcyjna w czasie najwyższego zapotrzebowania na energię. Jednostką jest
              gigawat (GW), jeden gigawat to 1000 megawatów.
            </p>
            <ComparisonTable
            ...
            <p>
              Współczynnik wykorzystania mocy (capacity factor) każdego źródła produkującego
              energię. Najwyższy to 100%, co oznaczałoby, że elektrownia działała z najwyższą mocą
              przez całą dobę, przez cały rok. Wszystkie elektrownie pracują tak dużo, jak to
              możliwe, z wyjątkiem ropy i gazu, które eksploatujemy tak mało, jak to możliwe, bez
              pwodowania deficytu energii w systemie.
            </p>
            <ComparisonTable
